"""
ResNet backbone with frozen BatchNorm, vendored from RelTR.

Original: https://github.com/yrcong/RelTR/blob/main/models/backbone.py
License: Apache 2.0
"""
import torch
...
class Backbone(BackboneBase):
    ...
    def __init__(self, name: str, train_backbone: bool,
        ...
        # Use weights parameter for modern torchvision compatibility
